...
public class TestBase {
	...
	protected void fillContactPage(ContactData contact) {
	    ...
	    driver.findElement(By.name("mobile")).sendKeys(contact.tel_mob);
	    ...
	    driver.findElement(By.name("phone2")).sendKeys(contact.second_tel_home);
	}
